@testset "VectorEuclid Tests" begin
	...
	@testset "constructor with StaticVector" begin
		v = VectorEuclid(SVector(1., 2., 3.0))
	...
	@testset "constructor with StaticVector for Float32" begin
		v = VectorEuclid(SVector{3, Float32}(ones(Float32, 3)))
	...
	@testset "property access" begin
		v = VectorEuclid(SVector(1.0, 3.0))
		@test v.x == 1.0
		@test v.y == 3.0
	end

	@testset "dot product" begin
		v1 = VectorEuclid(SVector(1., 2., 3.0))
		v2 = VectorEuclid(SVector(4.0, 5.0, 6.0))
	...
	@testset "test higher dimensions" begin
		v1 = VectorEuclid(SVector(1., 2., 3.0, 4.0, 5.0, 6.0, 7.0))
		v2 = VectorEuclid(SVector(7.0, 6.0, 5.0, 4.0, 3.0, 2.0, 1.0))
		@test length(v1) == 7
		@test dot(v1, v2) == sum(i * (8 - i) for i = 1 : 7) 
	end

	@testset "test lower dimensions" begin
		v1 = VectorEuclid(SVector(1., 2.))
		v2 = VectorEuclid(SVector(3.0, 4.0))
		@test length(v1) == 2
		@test v1.x == 1.0
		@test v1.y == 2.0
